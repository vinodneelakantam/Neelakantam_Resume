window.resumeDataV2 = {
    ...
    nationality: "Indian (DE-Niederlassungserlaubnis)",
    links: [
        {
            type: "linkedin",
            label: "LinkedIn",
    ...
    workExperience: [
        ...
        },
        {
            ...
            details: [
                ...
                "Performed system-level debugging and root cause analysis using Lauterbach, CANoe, and ODIS tools.",
                "Conducted protocol validation across automotive interfaces (CAN, Ethernet, SPI, I2C, UART) ensuring reliable communication.",
                "Contributed to ADAS system integration (camera & surround view) for OEMs like Volkswagen and Audi."
            ]
        },
        {
            ...
            details: [
                ...
                "Defined ASPICE-compliant CI testing and integration strategies ensuring audit readiness and process consistency.",
