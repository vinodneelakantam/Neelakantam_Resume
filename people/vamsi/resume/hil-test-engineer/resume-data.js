window.resumeData = {
    profileImage: "",
    nameFirst: "Vamsi Krishna Sai",
    nameLast: "Kavety",
    title: "HIL/SIL Test Engineer | Embedded Software Integration",
    address: "Regensburg, 93053",
    contact: {
        phone: "+49 17666340111",
        email: "vamsikrishnasai@gmail.com"
    },
    nationality: "German",
    links: [],
    education: [
        { degree: "Master of Science - Automotive Software Engineering", location: "TU Chemnitz, Germany", year: "2018" },
        { degree: "PG Program - Data Science & AI (pursuing)"} 
    ],
    skills: [
        "Test & Validation: HIL rigs (Vector VT System, RT Rack), Fault Insertion Unit (FIU), CANoe/CANalyzer, LabVIEW TestStand",
        "Embedded Programming: C/C++, Python, Shell",
        "Automotive Protocols: UART, CAN, RS-232, RS-485, UDS",
        "AUTOSAR & Config Tools: DaVinci, EB Tresos, ARXML files",
        "CI/CD & Test Automation: Jenkins, Git/Gerrit/GitLab, Jira, Continental ATP/TEMPPO",
        "DevOps & Cloud: Docker, Kubernetes, Terraform, Ansible, AWS, Azure",
        "Debuggers: Lauterbach/Trace32, JTAG, PE micro MULTILINK, ICAS1 Debugger",
        "Configuration Management: PTC Integrity, IBM DOORS, MKS",
        "Standards & Process: ASPICE (HWE.2, HWE.3, SWE.5), ISTQB Foundation, Agile/Scrum",
        "Cross Compilers/IDE: ARM GCC, GHS, S32 Design Studio, Eclipse, Visual Studio"
    ],
    languages: ["English - C1", "German - B1"],
    drivingLicense: "Class B/BE",
    aboutMe: [
    ...
    workExperience: [
        {
            title: "Software Engineer/Test Engineer - HIL (VW)",
            company: "Manu Dextra / Vitesco Technologies - Regensburg",
        ...
        {
            title: "Software Engineer - Vehicle Testing",
            company: "Manu Dextra / Continental Automotive - Regensburg",
        ...
        {
            title: "Software Engineer/Test Engineer - ECU Verification",
            company: "IPN Brainpower / Continental Engineering Services - Nurnberg",
        ...
        },
        {
            ...
            company: "Conti Temic Microelectronics GmbH (Body & Security) - Markdorf",
        ...
        {
            title: "Student Intern - Testing",
            company: "ADC Automotive Distance Control Systems GmbH - Lindau/Ulm",
        ...
        {
            title: "Senior Hardware Engineer / Senior HIL Test Engineer - Power Train",
            company: "Robert Bosch Engineering - Coimbatore, India",
            period: "May 2011 - Mar 2014",
            details: [
        ...
        {
            title: "Engineer R&D",
            company: "McML Protection Technologies - Hyderabad, India",
            period: "Jul 2009 - Apr 2011",
            details: [
